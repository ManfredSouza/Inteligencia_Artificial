...
def _print_population(pop, gen_number):
    print("\n--------------------------------------------------------------")
    print("Geração número", gen_number, "| Cromossomo de fitness mais apto:", pop.get_chromosomes() [0] .get_fitness())
    print("Cromossomo inicial:", TARGET_CHROMOSOME)
    print("--------------------------------------------------------------")
    i = 0
    for x in pop.get_chromosomes():
        print("Cromossomo #", i, " :", x, "| Fitness: ", x.get_fitness())
        i += 1
